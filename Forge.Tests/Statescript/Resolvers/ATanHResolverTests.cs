...
public class ATanHResolverTests
{
	...
	public void ATanH_resolver_half()
	{
		...
		resolver.Resolve(context).AsDouble().Should().BeApproximately(0.5493, TestUtils.Tolerance);
	}
	...
	public void ATanH_resolver_float_computation()
	{
		...
		resolver.Resolve(context).AsFloat().Should().BeApproximately(0.5493f, TestUtils.Tolerance);
	}
