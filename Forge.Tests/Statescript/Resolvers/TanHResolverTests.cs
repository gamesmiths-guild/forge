...
public class TanHResolverTests
{
	...
	public void TanH_resolver_one()
	{
		...
		resolver.Resolve(context).AsDouble().Should().BeApproximately(0.7616, TestUtils.Tolerance);
	}
	...
	public void TanH_resolver_float_computation()
	{
		...
		resolver.Resolve(context).AsFloat().Should().BeApproximately(0.7616f, TestUtils.Tolerance);
	}
