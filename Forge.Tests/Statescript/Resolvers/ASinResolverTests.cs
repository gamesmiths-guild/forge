...
public class ASinResolverTests
{
	...
	public void ASin_resolver_half_returns_pi_over_6()
	{
		...
		resolver.Resolve(context).AsDouble().Should().BeApproximately(Math.PI / 6.0, TestUtils.Tolerance);
	}
	...
	public void ASin_resolver_float_computation()
	{
		...
		resolver.Resolve(context).AsFloat().Should().BeApproximately(MathF.PI / 6.0f, TestUtils.Tolerance);
	}
