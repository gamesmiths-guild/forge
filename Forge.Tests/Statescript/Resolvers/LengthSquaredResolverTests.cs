...
public class LengthSquaredResolverTests
{
	...
	[Fact]
	[Trait("Resolver", "LengthSquared")]
	public void LengthSquared_resolver_quaternion_value_type_is_float()
	{
		var resolver = new LengthSquaredResolver(
	...
	[Fact]
	[Trait("Resolver", "LengthSquared")]
	public void LengthSquared_resolver_quaternion()
	{
		...
		resolver.Resolve(context).AsFloat().Should().Be(quaternion.LengthSquared());
	}
