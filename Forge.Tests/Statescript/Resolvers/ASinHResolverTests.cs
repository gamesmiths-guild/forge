...
public class ASinHResolverTests
{
	...
	public void ASinH_resolver_one()
	{
		...
		resolver.Resolve(context).AsDouble().Should().BeApproximately(0.88137, TestUtils.Tolerance);
	}
	...
	public void ASinH_resolver_float_computation()
	{
		...
		resolver.Resolve(context).AsFloat().Should().BeApproximately(0.88137f, TestUtils.Tolerance);
	}
