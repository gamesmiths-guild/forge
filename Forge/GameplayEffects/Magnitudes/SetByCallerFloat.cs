...
/// <remarks>
/// A <see cref="GameplayTag"/> is used for mapping different possible custom values.
/// </remarks>
public readonly struct SetByCallerFloat(GameplayTag tag) : IEquatable<SetByCallerFloat>
{
	/// <summary>
	/// Gets the tag used for identifying the custom value set.
	/// </summary>
	public readonly GameplayTag Tag { get; } = tag;
